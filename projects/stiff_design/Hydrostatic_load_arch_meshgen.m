...
function Hydrostatic_load_arch_meshgen
...
% Select and assign structural domain.
box.point_1 = [0.05, 0.0];
box.point_2 = [1.05, 1.0];
mesh = AssignStructuralRegion(mesh, box);

% Add Dirichlet boundary conditions
dirichlet.point_1 = [0.0499999, -0.0000001];
dirichlet.point_2 = [0.0500001, 0.0000001];
dirichlet.dofs = [1, 2];
dirichlet.value = 0;
mesh = AddDirichletBC(mesh,dirichlet);
dirichlet.point_1 = [1.0499999, -0.001];
dirichlet.point_2 = [1.0500001, 1.0000001];
dirichlet.dofs = [1];
dirichlet.value = 0;
mesh = AddDirichletBC(mesh,dirichlet);
dirichlet.point_1 = [-0.000001, 1.0499999];
dirichlet.point_2 = [1.050001, 1.05000001];
dirichlet.dofs = [4];
dirichlet.value = 1.0;
mesh = AddDirichletBC(mesh,dirichlet);
